...
<ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Relacionamento Professor / Turma</a></li>
    ...
    <div class="col-md-12">
        ...
        <div class="box box-info ">
            <div class="box-header with-border">
                <h3 class="box-title">Relacionamento Professor / Turma</h3>
            </div><!-- /.box-header -->
            <!-- form start -->
            <form id="form-relacionamento-at" class="form-horizontal" method="post"
                  action="{{ URL::to('admin/professor-turmas/create') }}"
                  autocomplete="off">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $("#submit").on('click',function(){
                ids = "";
                $("#turmas_selecionadas option").each(function(i) {
            ...
            $("#professor_id").on('change', function () {
                ...
                if(idProfessor != "") {
                    $.ajax({
                    dataType: "json",
                    url: "{{URL::to('admin/professor-turmas/1/turmas')}}".replace("1", idProfessor),
